package com.tecbeast.hdwallpapers.imagepicker.adapter;
...
public class ImagePickerAdapter extends RecyclerView.Adapter<ImagePickerAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(ImageViewHolder viewHolder, int position) {
        ...
        if (isSelected(image)) {
            ...
            ((FrameLayout) viewHolder.itemView).setForeground(ContextCompat.getDrawable(context, R.mipmap.ic_done_white));
        } else {
